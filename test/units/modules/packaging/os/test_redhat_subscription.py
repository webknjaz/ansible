...
@pytest.mark.parametrize('ansible_module_args, testcase', TEST_CASES, ids=TEST_CASES_IDS, indirect=['ansible_module_args'])
@pytest.mark.usefixtures('ansible_module_args')
...
@pytest.mark.parametrize('ansible_module_args, testcase', SYSPURPOSE_TEST_CASES, ids=SYSPURPOSE_TEST_CASES_IDS, indirect=['ansible_module_args'])
@pytest.mark.usefixtures('ansible_module_args')
def test_redhat_subscribtion_syspurpose(mocker, capfd, patch_redhat_subscription, ansible_module_args, testcase, tmpdir):
    """
