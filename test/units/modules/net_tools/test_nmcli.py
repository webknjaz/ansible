...
@pytest.mark.parametrize('ansible_module_args', TESTCASE_BOND, indirect=['ansible_module_args'])
...
@pytest.mark.parametrize('ansible_module_args', TESTCASE_GENERIC, indirect=['ansible_module_args'])
...
@pytest.mark.parametrize('ansible_module_args', TESTCASE_GENERIC_DNS4_SEARCH, indirect=['ansible_module_args'])
...
@pytest.mark.parametrize('ansible_module_args', TESTCASE_CONNECTION, indirect=['ansible_module_args'])
...
@pytest.mark.parametrize('ansible_module_args', TESTCASE_BRIDGE, indirect=['ansible_module_args'])
...
@pytest.mark.parametrize('ansible_module_args', TESTCASE_BRIDGE_SLAVE, indirect=['ansible_module_args'])
...
@pytest.mark.parametrize('ansible_module_args', TESTCASE_VLAN, indirect=['ansible_module_args'])
...
@pytest.mark.parametrize('ansible_module_args', TESTCASE_VXLAN, indirect=['ansible_module_args'])
...
@pytest.mark.parametrize('ansible_module_args', TESTCASE_IPIP, indirect=['ansible_module_args'])
...
@pytest.mark.parametrize('ansible_module_args', TESTCASE_SIT, indirect=['ansible_module_args'])
...
@pytest.mark.parametrize('ansible_module_args', TESTCASE_ETHERNET_DHCP, indirect=['ansible_module_args'])
